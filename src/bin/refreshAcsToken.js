...
function refreshOldToken() {
    ...
    Account
        ...
        .exec(function (err, accounts) {
            ...
            else console.info("\x1b[32minfo\x1b[0m:", "There is no token to refresh");
        })
}
//===============CREATE CRON=================
module.exports.auto = function () {
    ...
    refreshOldToken();
    try {
        console.info("\x1b[32minfo\x1b[0m:", "Starting process to automatically refresh Access Tokens every day.");
        new CronJob({
            // run the refresh process every day
            cronTime: "0 0 0 * * *",
            onTick: function () {
                refreshOldToken();
            },
